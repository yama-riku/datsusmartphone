...
<?php if ($str_language == 'de'): ?>
    ...
    <p class="text" id="footnote_1"><small><sup>1</sup> Dateien: <samp>login_form.php</samp> und <samp>MAMP-PRO-Logo.png</samp></small></p>
    <hr />
...
<?php elseif ($str_language == 'en'): ?>
    ...
    <p class="text" id="footnote_1"><small><sup>1</sup> Files: <samp>login_form.php</samp> and <samp>MAMP-PRO-Logo.png</samp></small></p>
    <hr />
