    ...
    if( isset( $_POST['edit_day'] )) {
        ...
        if($edit_day <= $day_count) {
            ...
            if ( isset( $_POST['edit_comment'] ) ) {
                ...
                // $work_table2 =  UserLogic::getworktable($login_user['email']);
...
// if ( isset( $_POST['edit_comment'] ) ) {
//     $edit_comment1 = $_POST['edit_comment'];
//     var_dump($edit_comment1);
// } else {
//     echo '受け取れてないよ';
// }
    ...
    <main>
        ...
        <form action = "" method = "POST">
            <div class = "edit">
                ...
                <textarea class = "input_comment" name = "edit_comment" rows = "4" cols = "40"></textarea><br>
